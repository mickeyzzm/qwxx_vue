    ...
    <div class="footerContent">
      <div class="box">
        ...
        <div class="function">
          ...
          <div class="funItem">功能模块</div>
          <div class="funItem">查询系统</div>
          <div class="funItem">应用平台</div>
          <div class="funItem">常用收藏</div>
        </div>
      </div>
    </div>
  </PageColumnVue>
        ...
        this.bddwClusterLayer = new mapvgl.ClusterLayer({
          ...
          onClick(e) {
            ...
            if (e.dataItem) {
              ...
              label.setStyle({ width: "280px", display: "" });
              var content =
                '<div id="containerOne">' +
...
.col_2_container {
  ...
  .topSearchContent {
    ...
    .text {
      ...
      text-align: center;
      padding-left: 5px;
      background: linear-gradient(90deg, #eaf5ff 0%, #0e4578 100%);
  ...
  .leftServiceDuties {
    ...
    .serviceDutiesCon {
      ...
      overflow: auto;
      padding: 10px;
      background: url("@/assets/images/layout/Rectangle34624260@2x.png")
        no-repeat;
      background-size: 100% 100%;
