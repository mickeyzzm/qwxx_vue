...
export function showJqMap(map,x,y){
    ...
    marker.xyPoint=point
    marker.addEventListener('click',function(){
        console.log("点击警情");
        showLabel(map,this.xyPoint);
    });
    // console.log("生成警情marker",marker);
}
...
//         map.removeOverlay(label);
//     });
// var point = new BMapGL.Point(117.972055, 40.958455);
	map.centerAndZoom(point, 10);
var opts = {
    position: point, // 指定文本标注所在的地理位置
    offset: new BMapGL.Size(30, -30), // 设置文本偏移量
}
var label = new BMapGL.Label("欢迎使用百度地图JSAPI WebGL版本<span class='arrow'></span>", opts);  // 创建文本标注对象
label.setStyle({
