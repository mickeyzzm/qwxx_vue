...
const routes = [
  ...
  },
  {
    ...
    // children: [
    //   { 
    //     path: '/MajorEvent/detail', 
    //     name: "MajorEvent/detail",
    //     component: () =>
    //     import(
    //       /* webpackChunkName: "about" */ "../views/MajorEvent/detailIndex.vue"
    //     )
    //   },
    // ]
  },
  ...
  {
    path: "/EventHandle/detail",
    name: "EventHandle/detail",
    component: () =>
      import(
        /* webpackChunkName: "about" */ "../views/EventHandle/detailIndex.vue"
      ), 
  },
  {
    path: "/CollaCommand",
