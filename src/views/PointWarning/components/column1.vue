<template>
  <PageColumnVue class="col_1_container" :width="33.33">
    <TopBlockVue title="人员布控概览" icon="Frame002x" />
    <div class="col_1_w">
        <div class="c_1_l_1_w">
            <SubBlockVue tabs="近7天人员布控信息统计" :moreShow="false">
        ...
        <div class="c_1_l_3_w">
            <SubBlockVue tabs="人民触网抓拍照片" :moreShow="false">
                <div class="c_1_l_2_b">
                    ...
                    <img src="../../../assets/images/layout/Maskroup@2x.png" alt="" class="img">
                    <p class="text">张某三</p>
...
<script>
  ...
  export default {
    ...
    methods: {
      lineTopEchart () {
        let dom = document.getElementById("col7_chartLine");
      ...
      lineBotpEchart () {
        let dom = document.getElementById("col30_chartLine");
